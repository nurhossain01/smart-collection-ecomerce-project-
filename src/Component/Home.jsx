...
import programming from "../../public/8306-programming-animation.json";
        ...
        <div className="flex flex-col items-center justify-between w-full mb-10 lg:flex-row">
          <div className="mb-16 lg:mb-0 lg:max-w-lg lg:pr-5">
            ...
            <div className="flex items-center space-x-3 my-4 ">
              <Link to='/shop'>
                <button
                  className="inline-flex bg-slate-500 items-center justify-center h-12 px-6 mr-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-deep-purple-accent-400 hover:bg-slate-700 focus:shadow-outline focus:outline-none"
                >
                  Get started
                </button>
              </Link>
              <Link to='/about'>
                <button
                  className="inline-flex bg-yellow-700 items-center justify-center h-12 px-6 mr-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-deep-purple-accent-400 hover:bg-slate-700 focus:shadow-outline focus:outline-none"
                >
                  Learn more
                </button>
              </Link>
